...
INSERT INTO `activator` (`id`, `created_at`, `updated_at`, `tanggal`, `lunas`) VALUES
	(3, '2013-06-16 09:59:52', '2013-07-16 04:25:15', '2013-07-22', 'N');
...
INSERT INTO `appsetting` (`id`, `created_at`, `updated_at`, `biaya_id`, `mysqldumppath`, `cetaknota`, `printeraddr`, `lunas`, `linekertas`, `spaceprinter`, `charcount`, `sn_key`) VALUES
	(1, '2013-05-31 10:03:45', '2013-07-16 08:48:05', 1, 'C:\\xampp\\mysql\\bin\\', 'N', '//192.168.1.254/lx_300_sdi', 'N', 30, 14, 56, 'TkQtZ3QtTlUtSXQtTXota3QtTVUtTXQtUkQtVXQtT0UtRT0=');
...
-- Dumping data for table simasad.ketentuanbiaya: ~0 rows (approximately)
...
INSERT INTO `permissions` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES
	...
	(16, 'manage_beasiswa', 'Mengelola Data Beasiswa & Bantuan Biaya Pendidikan', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
INSERT INTO `permission_role` (`id`, `permission_id`, `role_id`, `created_at`, `updated_at`) VALUES
	...
	(47, 16, 1, '2013-07-15 15:53:10', '2013-07-15 15:53:10');
...
-- Dumping data for table simasad.siswa: ~237 rows (approximately)
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` VIEW `vtargetpencapaian` AS select `ta`.`id` AS `id`,`ta`.`nama` AS `nama`,`ta`.`aktif` AS `aktif`,`ta`.`posisi` AS `posisi`,ifnull(`tp`.`jumlah`,0) AS `jumlah`,`tp`.`id` AS `target_id` from (`tahunajaran` `ta` left join `target_pencapaian` `tp` on((`tp`.`tahunajaran_id` = `ta`.`id`))) ;
