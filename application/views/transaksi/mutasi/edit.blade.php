    ...
    <script type="text/javascript">
        jQuery(document).ready(function(){
            ...
            //format rupiah on load
            formatRupiah(jQuery('.uang').attr('id'));
...
<div class="row-fluid sortable ui-sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <?php echo Laravel\Form::open(URL::to('transaksi/mutasi/edit'));?>
                <fieldset class="form-horizontal">
                    <?php echo Laravel\Form::hidden('mutasi_id', $mutasi->id); ?>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php echo Laravel\Form::text('tanggal',$mutasi->tanggal,array('class'=>'input-medium datepicker','required')); ?>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">
                        ...
                        <div class="controls">
                            <?php echo Laravel\Form::select('asal',array('KU'=>'Kas Utama','KB'=>'Bank'),$mutasi->asal,array('class'=>'input-medium','required')); ?>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">
                        ...
                        <div class="controls">
                            <?php echo Laravel\Form::select('tujuan',array('KU'=>'Kas Utama','KB'=>'Bank'),$mutasi->tujuan,array('class'=>'input-medium','required')); ?>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">
                        ...
                        <div class="controls">
                            <?php echo Laravel\Form::text('jumlah',$mutasi->jumlah,array('class'=>'input-medium uang','id'=>'jumlah','required','autocomplete' => 'off')); ?>
                        </div>
                    </div>
