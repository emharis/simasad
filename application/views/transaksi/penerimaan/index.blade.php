        ...
        jQuery(document).ready(function(){
            ...
            jQuery('#selectBiaya').change(function(){
               ...
               jQuery.ajaxSetup ({cache: false});
                var getTipeBiayaUrl = "{{ URL::to('transaksi/penerimaan/jsnGetBiaya') }}" + "/" + jenisbiayaid;
                ...
                if(biaya.tipe == 'BTBI'){
                    ...
                    jQuery.ajaxSetup ({cache: false});
                    var getKetBiayaUrl = "{{ URL::to('transaksi/penerimaan/jsonketentuanbiaya') }}" + "/" + tahunajaranid + "/" + jenisbiayaid + "/BTBI";
                    jQuery.ajax({url:getKetBiayaUrl,dataType:"json",async:false,
                        success:function(data){
                            ...
                            alert('.:: PERINGATAN ::. Nilai Biaya belum ditentukan/ditetapkan.');
                        }
                    });
             ...
             */
            function addDetilTransaction(biayanya,jumlahnya){
                //simpan kedalam array of json
                jsonDataTrans = {"biayaid":biayanya.id,"jumlah":jumlahnya,"rownum":rowDetilTrans};
                ...
                var newRow = "<tr id='row_" + rowDetilTrans + "' ><td>" + biayanya.nama + "</td><td>" + formatRupiahVal(jumlahnya) + "</td><td><a tag='" + rowDetilTrans + "' href='#' class='btn btn-mini btn-warning linkDelete'>Delete</a></td></tr>";
            ...
            jQuery('#buttonBayar').click(function(){
                if(detilTrans.length > 0){
                    ...
                    $.post("{{ URL::to('transaksi/penerimaan/inserttrans') }}", {
...
<!--                        <div>
				...
				<div class="box span12">
                                    <div class="box-header well" data-original-title="">
                                            <h2><i class="icon-share-alt"></i> Transaksi Penerimaan</h2>
                                            <div class="box-icon">
                                                            ...
                                                            <td id="formBayar">
                                                                <table>
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>Bayar</td>
                                                                            <td>{{ \Laravel\Form::text('textBayar', null,array('id'=>'textBayar','class'=>'input-medium uang','placeholder'=>'Rp. 0')) }}</td>
