...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        function loadJenisBiaya(){
            ...
            var jenis = "{{ $jenisbiaya->tipe }}";
            var perjenjang = "{{ $jenisbiaya->perjenjang }}";
            var arus = "{{ $jenisbiaya->arus }}";
					...
					<div class="box-content">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                          {{ Form::text('nama',$jenisbiaya->nama,array('class'=>'input-large','required','id'=>'textNama')) }}
                                                    </div>
                                                </div>
                                                <div class="control-group">
