...
/**
 * Description of penerimaan
 *
 * @author root
 */
class Transaksi_Penerimaan_Controller extends Base_Controller {
    public function __construct() {
        ...
        //filter permission
        $this->filter('before', 'permission:manage_transaksi_penerimaan');
    }
    ...
    public function get_index(){
        ...
        $this->layout->nest('content', 'transaksi.penerimaan.index',array(
    ...
    public function post_inserttrans(){
        ...
        return \Laravel\Redirect::to('transaksi/penerimaan');
