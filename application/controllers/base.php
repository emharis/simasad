...
//                Asset::container('header')->add('style-default', 'css/style.default.css');
                ...
                Asset::container('header')->add('clock', 'css/clock.css');
                Asset::container('header')->add('flatten', 'css/flatten.bootstrap.css');
                ...
                Asset::container('footer')->add('jclock', 'js/jquery.jclock.js');
                Asset::container('footer')->add('rupiah', 'js/rupiah.js');
                
                $this->layout->web_title = '.: SIMAS-ad :.';
                $this->layout->app_name = 'SISTEM ADMINISTRASI KEUANGAN SEKOLAH';
                $setting = Setting::first();
                $this->layout->syssetting = $setting;
                $this->layout->tahunaktif = Tahunajaran::where('aktif','=','Y')->first();
